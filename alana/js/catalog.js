...
async function displayPage(clientChoose, currentPage, buttonsCount, cardsPerPage) {
    try {
        ...
        if (filteredProducts !== null) {
            ...
            p.textContent = 'Нет товаров, удовлетворяющих вашему запросу. Попробуйте изменить фильтры.';
...
function displayProductList(products) {
    ...
    // ищем все карточки товаров на странице и добавляем обработчик кликов на них
...
async function main() {
    try {
        ...
        let cardsPerPage = 9; // количество карточек на одной странице
